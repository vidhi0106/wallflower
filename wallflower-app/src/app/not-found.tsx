...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6" style={{ color: "#4a3d2c" }}>
      ...
      <h1 className="font-caveat font-bold text-[32px] mt-4">This garden doesn&rsquo;t exist</h1>
      <p className="mt-2.5 text-[16px] max-w-sm" style={{ color: "#7c6a4e", lineHeight: 1.6 }}>
      ...
      <Link
        ...
        style={{ background: "#6b7d5c", color: "#FBF6E9", borderRadius: 10, padding: "12px 22px", fontSize: 17 }}
      >
        Back to Wallflower
      </Link>
    </div>
